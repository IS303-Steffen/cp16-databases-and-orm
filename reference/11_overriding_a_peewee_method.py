...
kwargs_example(text="hello", more_text="world")
...
kwargs_example_2(example="something", name="John")
...
class Customer(Model):
    ...
    def create(cls, **query):
        ...
        if email:
            if '@' not in email:
                print("A valid email must be provided")
                return
...
Customer.create(name="Priya", email="blabla@example.com", birth_year=2000, state="CA")
